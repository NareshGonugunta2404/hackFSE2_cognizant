...
class AddProduct extends React.Component {
    ...
    handleChange7(val) { 
      this.setState({sellerId: val.target.value});
       ...
       handleSubmit(event) {
         fetch('http://localhost:8080/e-auction/api/v1/seller/add-product', {  // Enter your IP address here
      method: 'POST',
      headers: {
  ...
  return (
    <><Router>
          <Routes>
              <Route exact path="/" component={RegisterNewCompany} />
              <Route path="/DeleteBids" component={SeacrhCompany} />
              <Route path="/UpdateBid" component={DisplayAllCompaniesStocks} />
              <Route path="/DeleteBids" component={DeleteCompany} />
              <Route path="/DeleteBids" component={AddNewStockPrice} />
              <Route path="/DeleteBids" component={FetchStcokPriceList} />
